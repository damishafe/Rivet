...
Total: **3 min 55 s**. Aim for one take per section rather than one take overall.
...
> audit. Cold, this takes sixty-eight seconds end to end. Forty-one with the models
> already resident."
...
> "Every scene passes ten checks. Not a score — named checks with observed values. The
...
## 3:25 – 3:55 · Evidence, and the close
...
> Python layer. Twenty-seven checks, a passing export, zero connection attempts. It is
> genuinely local.
>
...
> "Rivet. Verified advertising on one Radeon GPU. The model gets to be creative. It
> doesn't get to be trusted."
